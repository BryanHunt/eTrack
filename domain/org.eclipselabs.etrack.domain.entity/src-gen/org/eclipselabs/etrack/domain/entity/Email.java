 ...
 * @generated
 */
public class Email extends MinimalEObjectImpl.Container implements CategorizedItem
{
  /**
   ...
   * @see org.eclipselabs.etrack.domain.entity.EntityPackage#getEmail_Address()
   * @model unique="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.etrack.domain.entity.Email#getAddress <em>Address</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public void setAddress(String newAddress)
  {
    ...
    address = newAddress;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.EMAIL__ADDRESS, oldAddress, address));
  }
