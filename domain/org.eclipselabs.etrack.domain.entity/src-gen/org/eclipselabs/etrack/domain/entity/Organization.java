...
public class Organization extends Entity implements Group
{
   ...
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%org.eclipselabs.etrack.domain.entity.Group%> _this = this;\nreturn _this.getName();'"
   * @generated
   */
  ...
  public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
  {
    if (baseClass == Identity.class)
    {
      ...
      {
        case EntityPackage.IDENTITY___GET_DISPLAY_NAME: return EntityPackage.ORGANIZATION___GET_DISPLAY_NAME;
    ...
    if (baseClass == Entity.class)
    {
      switch (baseOperationID)
      {
        case EntityPackage.ENTITY___GET_DISPLAY_NAME: return EntityPackage.ORGANIZATION___GET_DISPLAY_NAME;
        default: return super.eDerivedOperationID(baseOperationID, baseClass);
      }
    }
    if (baseClass == Group.class)
    {
      switch (baseOperationID)
      {
        case EntityPackage.GROUP___GET_DISPLAY_NAME: return EntityPackage.ORGANIZATION___GET_DISPLAY_NAME;
        default: return -1;
      }
    }
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException
  {
    switch (operationID)
    {
      case EntityPackage.ORGANIZATION___GET_DISPLAY_NAME:
