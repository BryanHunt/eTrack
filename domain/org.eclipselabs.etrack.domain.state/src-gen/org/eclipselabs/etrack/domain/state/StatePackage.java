...
public class StatePackage extends EPackageImpl
{
   ...
   * @generated
   */
  public static final String eNS_URI = "org.eclipselabs.etrack.domain.state";
   ...
   * @generated
   */
  public static final String eNS_PREFIX = "state";
   ...
   * @generated
   */
  public static final int STATE_TRANSITION_MAPPING = 3;
  ...
  /**
   * The number of operations of the '<em>Transition Mapping</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  public static final int STATE_TRANSITION_MAPPING_OPERATION_COUNT = 0;
   ...
   * @ordered
   */
  public static final int STATE_CHANGE_OPERATION_COUNT = AuditPackage.ACTION_OPERATION_COUNT + 0;
   ...
   * @ordered
   */
  public static final int STATE_GROUP_OPERATION_COUNT = 0;
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getStateMachine_StartingState(), this.getState(), null, "startingState", null, 0, 1, StateMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getStateTransition_Name(), theEcorePackage.getEString(), "name", null, 0, 1, StateTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getStateGroup_Name(), theEcorePackage.getEString(), "name", null, 0, 1, StateGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
