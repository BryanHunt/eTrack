 ...
 * <ul>
 *   <li>{@link org.eclipselabs.etrack.domain.data.Artifact#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.etrack.domain.data.Artifact#getCreatedOn <em>Created On</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public class Artifact extends MinimalEObjectImpl.Container implements EObject
{
  /**
   ...
   * @see #setName(String)
   * @see org.eclipselabs.etrack.domain.data.DataPackage#getArtifact_Name()
   * @model unique="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.etrack.domain.data.Artifact#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipselabs.etrack.domain.data.DataPackage#getArtifact_CreatedOn()
   * @model unique="false" dataType="org.eclipselabs.etrack.domain.data.Date"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.etrack.domain.data.Artifact#getCreatedOn <em>Created On</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
