 ...
 * @generated
 */
public class LinkMapping extends EObjectImpl implements BasicEMap.Entry<String,LinkedContent>, EObject
{
	/**
	 ...
	 * @see org.eclilpselabs.etrack.domain.data.DataPackage#getLinkMapping_Key()
	 * @model
	 * @generated
	 */
	 ...
	 * @see org.eclilpselabs.etrack.domain.data.DataPackage#getLinkMapping_Value()
	...
	public LinkedContent getTypedValue()
	{
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				...
				NotificationChain msgs = oldValue.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataPackage.LINK_MAPPING__VALUE, null, null);
				if (newValue.eInternalContainer() == null) {
					msgs = newValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataPackage.LINK_MAPPING__VALUE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataPackage.LINK_MAPPING__VALUE, oldValue, value));
			}
		}
		return value;
	}
