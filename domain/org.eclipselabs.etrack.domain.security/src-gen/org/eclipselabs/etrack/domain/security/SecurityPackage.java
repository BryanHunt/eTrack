...
public class SecurityPackage extends EPackageImpl
{
   ...
   * @generated
   */
  public static final String eNS_URI = "org.eclipselabs.etrack.domain.security";
   ...
   * @ordered
   */
  public static final int PERMISSION_GROUP___GET_DISPLAY_NAME = EntityPackage.GROUP___GET_DISPLAY_NAME;

  /**
   * The number of operations of the '<em>Permission Group</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  public static final int PERMISSION_GROUP_OPERATION_COUNT = EntityPackage.GROUP_OPERATION_COUNT + 0;
  ...
  /**
   * The number of operations of the '<em>Password Credential</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  public static final int PASSWORD_CREDENTIAL_OPERATION_COUNT = 0;
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getPasswordCredential_ID(), theEcorePackage.getEString(), "ID", null, 0, 1, PasswordCredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPasswordCredential_Password(), theEcorePackage.getEString(), "password", null, 0, 1, PasswordCredential.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
