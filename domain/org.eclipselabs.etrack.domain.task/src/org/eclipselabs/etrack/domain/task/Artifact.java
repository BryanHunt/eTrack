 ...
 * <ul>
 *   <li>{@link org.eclipselabs.etrack.domain.task.Artifact#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.etrack.domain.task.Artifact#getCreatedOn <em>Created On</em>}</li>
 * </ul>
 * </p>
 *
...
public class Artifact extends EObjectImpl implements EObject
{
	...
	{
		return TaskPackage.Literals.ARTIFACT;
	}
	 ...
	 * @see #setName(String)
	 * @see org.eclipselabs.etrack.domain.task.TaskPackage#getArtifact_Name()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipselabs.etrack.domain.task.Artifact#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.ARTIFACT__NAME, oldName, name));
	}
	 ...
	 * @see org.eclipselabs.etrack.domain.task.TaskPackage#getArtifact_CreatedOn()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipselabs.etrack.domain.task.Artifact#getCreatedOn <em>Created On</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setCreatedOn(Date newCreatedOn)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.ARTIFACT__CREATED_ON, oldCreatedOn, createdOn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case TaskPackage.ARTIFACT__NAME:
				return getName();
			case TaskPackage.ARTIFACT__CREATED_ON:
				return getCreatedOn();
		}
