 ...
 * @generated
 */
public class TaskQuery extends MinimalEObjectImpl.Container implements AssignableItem
{
  /**
  ...
  {
    return TaskPackage.Literals.TASK_QUERY;
  }
    ...
    if (owner != null && owner.eIsProxy())
    {
      ...
      if (owner != oldOwner)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaskPackage.TASK_QUERY__OWNER, oldOwner, owner));
      }
    }
    return owner;
  }
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.etrack.domain.task.TaskQuery#getOwner <em>Owner</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public void setOwner(Person newOwner)
  {
    ...
    owner = newOwner;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.TASK_QUERY__OWNER, oldOwner, owner));
  }
   ...
   * @see #setQuery(String)
   * @see org.eclipselabs.etrack.domain.task.TaskPackage#getTaskQuery_Query()
   * @model unique="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.etrack.domain.task.TaskQuery#getQuery <em>Query</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public void setQuery(String newQuery)
  {
    ...
    query = newQuery;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.TASK_QUERY__QUERY, oldQuery, query));
  }
