 ...
 * <ul>
 *   <li>{@link org.eclipselabs.etrack.domain.task.AttributeChange#getOldValue <em>Old Value</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public class AttributeChange extends Action
{
  /**
  ...
  {
    return TaskPackage.Literals.ATTRIBUTE_CHANGE;
  }
   ...
   * @see org.eclipselabs.etrack.domain.task.TaskPackage#getAttributeChange_OldValue()
   * @model unique="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipselabs.etrack.domain.task.AttributeChange#getOldValue <em>Old Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public void setOldValue(String newOldValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.ATTRIBUTE_CHANGE__OLD_VALUE, oldOldValue, oldValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TaskPackage.ATTRIBUTE_CHANGE__OLD_VALUE:
        return getOldValue();
    }
