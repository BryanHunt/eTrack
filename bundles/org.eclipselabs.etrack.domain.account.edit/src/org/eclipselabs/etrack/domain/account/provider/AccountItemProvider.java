		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Account_creationDate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Account_creationDate_feature", "_UI_Account_type"),
				 AccountPackage.Literals.ACCOUNT__CREATION_DATE,
				 true,
				 false,
				 false,
	...
	protected void addLastPasswordChangePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Account_lastPasswordChange_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Account_lastPasswordChange_feature", "_UI_Account_type"),
				 AccountPackage.Literals.ACCOUNT__LAST_PASSWORD_CHANGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEntityPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Account_entity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Account_entity_feature", "_UI_Account_type"),
				 AccountPackage.Literals.ACCOUNT__ENTITY,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(AccountPackage.Literals.ACCOUNT__CREDENTIAL);
		}
	...
	{
		Date labelValue = ((Account)object).getCreationDate();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(AccountPackage.Literals.ACCOUNT__CREDENTIAL,
