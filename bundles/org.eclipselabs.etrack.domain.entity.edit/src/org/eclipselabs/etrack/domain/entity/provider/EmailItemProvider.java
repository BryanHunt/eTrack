...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.etrack.domain.entity.Email} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Email_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Email_address_feature", "_UI_Email_type"),
				 EntityPackage.Literals.EMAIL__ADDRESS,
				 true,
				 false,
				 false,
	...
	{
		String label = ((Email)object).getCategory();
