 ...
 * <ul>
 *   <li>{@link org.eclipselabs.etrack.developer.database.Accounts#getAccounts <em>Accounts</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public class Accounts extends MinimalEObjectImpl.Container implements EObject
{
  /**
  ...
  {
    return DatabasePackage.Literals.ACCOUNTS;
  }
   ...
   * @see org.eclipselabs.etrack.developer.database.DatabasePackage#getAccounts_Accounts()
  ...
  public EList<Account> getAccounts()
  {
    if (accounts == null)
    {
      accounts = new EObjectContainmentEList<Account>(Account.class, this, DatabasePackage.ACCOUNTS__ACCOUNTS);
    }
    return accounts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DatabasePackage.ACCOUNTS__ACCOUNTS:
