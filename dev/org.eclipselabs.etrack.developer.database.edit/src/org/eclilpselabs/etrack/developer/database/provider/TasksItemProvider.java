...
/**
 * This is the item provider adapter for a {@link org.eclilpselabs.etrack.developer.database.Tasks} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(DatabasePackage.Literals.TASKS__TASKS);
		}
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Tasks"));
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(Tasks.class))
		{
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(DatabasePackage.Literals.TASKS__TASKS,
