...
public class AccountAdapterFactory extends AdapterFactoryImpl
{
	...
	protected AccountSwitch<Adapter> modelSwitch =
		new AccountSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseAccountRequest(AccountRequest object)
			{
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipselabs.etrack.domain.account.Account <em>Account</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipselabs.etrack.domain.account.AccountRequest <em>Request</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipselabs.etrack.domain.account.LocalAccount <em>Local Account</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
